              ...
              child: Row(
                ...
                children: [
                  ...
                  if (widget.user?.country == 'Malaysia')
                    Text(
                      '${functions.centStripe(widget.user!.bag.priceInt.toDouble()).toString()} RM',
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            fontFamily: 'Open Sans',
                            fontWeight: FontWeight.bold,
                          ),
                  ...
                  if (widget.user?.country == 'Singapore')
                    Text(
                      valueOrDefault<String>(
                        '${functions.centStripe(widget.user!.bag.priceInt.toDouble()).toString()} S\$',
                        'S\$',
                      ),
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            fontFamily: 'Open Sans',
                  ...
                  if (widget.user?.country == 'Philippines')
                    Text(
                      '${functions.centStripe(widget.user!.bag.priceInt.toDouble()).toString()} PHP',
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            fontFamily: 'Open Sans',
                            fontWeight: FontWeight.bold,
                          ),
                    ...
                    builder: (context) => StreamBuilder<UserRecord>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'PAYMENT_TAB_COMP_LUNGTI_PAY_BTN_ON_TAP');
                            if (valueOrDefault(
                              ...
                              await ordersRecordReference
                                ...
                                store: buttonUserRecord.reference,
                      ...
                      return FFButtonWidget(
                        onPressed: () async {
                          ...
                          final paymentResponse = await processStripePayment(
                            context,
                            amount: widget.user!.bag.priceInt,
                            currency: 'PHP',
                          ...
                          _model.orderNumber = OrdersRecord.getDocumentFromData(
                              createOrdersRecordData(
                                quantity: _model.countControllerValue,
                                pickedUp: false,
                                userRef: currentUserReference,
                          ...
                          await widget.user!.reference.update({
                            ...
                            'total_earnings':
                                FieldValue.increment(widget.user!.bag.priceInt),
                            'next_bag_amounth': FieldValue.increment(
                                _model.countControllerValue!),
                            'fianl_payout': FieldValue.increment(
                                functions.finalPayPHP(
