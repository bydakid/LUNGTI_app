      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Profiel')
              : NavBarPage(
                  initialPage: 'Profiel',
                  page: ProfielWidget(),
                ),
        ...
        FFRoute(
          name: 'Login_Country',
          path: '/loginCountry',
          builder: (context, params) => LoginCountryWidget(),
        ),
        FFRoute(
          name: 'Info',
          path: '/info',
        ...
        FFRoute(
          ...
          path: '/emailCheck',
          requireAuth: true,
          builder: (context, params) => EmailCheckWidget(),
        ),
        FFRoute(
          name: 'Support',
          path: '/support',
        ...
        FFRoute(
          ...
          path: '/storeInfo',
          asyncParams: {
            'storeRef': getDoc(['store'], StoreRecord.fromSnapshot),
          },
        ...
        FFRoute(
          ...
          path: '/orderCollected',
          requireAuth: true,
          builder: (context, params) => OrderCollectedWidget(),
        ),
        FFRoute(
          name: 'Payment',
          path: '/payment',
